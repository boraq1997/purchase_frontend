import {
  blockBodyScroll,
  unblockBodyScroll
} from "./chunk-Y7ZSBNFZ.js";
import {
  FocusTrap
} from "./chunk-RRNCCEUD.js";
import {
  script as script7
} from "./chunk-T3GDEV55.js";
import {
  script as script6
...
var script$3 = {
  ...
  methods: {
    ...
    onRightKey: function onRightKey() {
      var indicators = _toConsumableArray$1(Y(this.$refs.indicatorContent, '[data-pc-section="indicator"]'));
...
var script$2 = {
  ...
  methods: {
    ...
    onRightKey: function onRightKey2() {
      var indicators = Y(this.$refs.itemsContainer, '[data-pc-section="thumbnailitem"]');
      var activeIndex2 = this.findFocusedIndicatorIndex();
      this.changedFocusedIndicator(activeIndex2, activeIndex2 + 1 === indicators.length ? indicators.length - 1 : activeIndex2 + 1);
    },
    ...
    onTabKey: function onTabKey2() {
      var indicators = _toConsumableArray(Y(this.$refs.itemsContainer, '[data-pc-section="thumbnailitem"]'));
      var highlightedIndex = indicators.findIndex(function(ind) {
        return Q(ind, "data-p-active") === true;
      });
    ...
    createStyle: function createStyle() {
      if (!this.thumbnailsStyle) {
        ...
        _t(this.thumbnailsStyle, "nonce", (_this$$primevue = this.$primevue) === null || _this$$primevue === void 0 || (_this$$primevue = _this$$primevue.config) === null || _this$$primevue === void 0 || (_this$$primevue = _this$$primevue.csp) === null || _this$$primevue === void 0 ? void 0 : _this$$primevue.nonce);
...
//# sourceMappingURL=chunk-VRUHID6R.js.map
