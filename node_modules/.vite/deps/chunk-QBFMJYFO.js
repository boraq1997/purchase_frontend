...
var script4 = {
  ...
  methods: {
    ...
    onEnterKey: function onEnterKey(event) {
      var _this = this;
      var items = Y(this.container, '[data-pc-section="item"]');
    ...
    calculatePointStyle: function calculatePointStyle(index) {
      ...
      if (type !== "linear") {
        ...
        if (type === "circle") {
          ...
          return {
            left: "calc(".concat(radius * Math.cos(step * index), "px + ").concat(rr("item.diff.x", "0px").variable, ")"),
            top: "calc(".concat(radius * Math.sin(step * index), "px + ").concat(rr("item.diff.y", "0px").variable, ")")
          };
        } else if (type === "semi-circle") {
          var direction = this.direction;
          var _step = Math_PI / (length - 1);
          var x = "calc(".concat(radius * Math.cos(_step * index), "px + ").concat(rr("item.diff.x", "0px").variable, ")");
...
//# sourceMappingURL=chunk-QBFMJYFO.js.map
