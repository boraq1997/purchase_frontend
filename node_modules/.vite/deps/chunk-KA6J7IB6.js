...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), s4 = d.height, a2 = d.width, u = e.offsetHeight, c = e.offsetWidth, f2 = e.getBoundingClientRect(), g2 = $(), it = k(), lt = h(), L, N2, ot = "top";
...
function I(t2, e, o = true, n = void 0) {
  var r;
  if (t2) {
    let i2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), l2 = e.offsetHeight, d = e.getBoundingClientRect(), s4 = h(), a2, u, c = n != null ? n : "top";
...
function j(t2, e) {
  ...
  if (t2) switch (t2) {
    ...
    default: {
      ...
      let l2 = ((s4) => typeof s4 == "function" && "call" in s4 && "apply" in s4)(t2) ? t2() : t2, d = H2(l2);
...
function zt(t2, e) {
  var o, n;
  if (t2) {
    let r = t2.parentElement, i2 = K(r), l2 = h(), d = t2.offsetParent ? t2.offsetWidth : J(t2), s4 = t2.offsetParent ? t2.offsetHeight : G2(t2), a2 = v((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), u = C2((n = r == null ? void 0 : r.children) == null ? void 0 : n[0]), c = "", f2 = "";
...
var D2 = (e, t2, r) => {
  e = Te(e), t2 = Te(t2);
  let a2 = (r / 100 * 2 - 1 + 1) / 2, n = 1 - a2, l2 = Ne(e), o = Ne(t2), c = Math.round(l2.r * a2 + o.r * n), m2 = Math.round(l2.g * a2 + o.g * n), d = Math.round(l2.b * a2 + o.b * n);
  return gt(c, m2, d);
};
...
var w3 = (e = {}) => {
  ...
  return { preset(s4) {
    ...
    var o, c;
    let { semantic: i2 } = t2 || {}, a2 = s4 && Object.hasOwn(s4, "light") ? s4.light : s4, n = s4 && Object.hasOwn(s4, "dark") ? s4.dark : s4, l2 = { colorScheme: { light: h2(h2({}, (o = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : o.light), !!a2 && { surface: a2 }), dark: h2(h2({}, (c = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : c.dark), !!n && { surface: n }) } };
...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(t2) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j2 } = m2, O2 = v2(m2, ["colorScheme", "extend", "css"]), d = T2 || {}, { colorScheme: M2 } = d, z3 = v2(d, ["colorScheme"]), u = R2 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), g2 = M2 || {}, { dark: te2 } = g2, re2 = v2(g2, ["dark"]), K2 = s(O2) ? this._toVariables({ [y2]: h2(h2({}, O2), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y2]: h2(h2({}, L), re2) }, r) : {}, X = s(V2) ? this._toVariables({ [y2]: h2(h2({}, V2), te2) }, r) : {}, [G3, U2] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B2, I2] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H3, W2] = [(p2 = X.declarations) != null ? p2 : "", X.tokens || []], q2 = this.transformCSS(y2, `${G3}${B2}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H3, "dark", "variable", r, i2, a2, n);
...
//# sourceMappingURL=chunk-KA6J7IB6.js.map
