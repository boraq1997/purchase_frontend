...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s2(t2) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j } = m2, O = v2(m2, ["colorScheme", "extend", "css"]), d = T2 || {}, { colorScheme: M2 } = d, z3 = v2(d, ["colorScheme"]), u = R2 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), g2 = M2 || {}, { dark: te } = g2, re2 = v2(g2, ["dark"]), K2 = s2(O) ? this._toVariables({ [y2]: h2(h2({}, O), z3) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y2]: h2(h2({}, L), re2) }, r) : {}, X = s2(V2) ? this._toVariables({ [y2]: h2(h2({}, V2), te) }, r) : {}, [G3, U2] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B2, I2] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H2, W2] = [(p2 = X.declarations) != null ? p2 : "", X.tokens || []], q2 = this.transformCSS(y2, `${G3}${B2}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H2, "dark", "variable", r, i2, a2, n);
    l2 = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U2, ...I2, ...W2])], c = m(j, { dt: E2 });
  }
  ...
  if (s2(t2)) {
    ...
    if (s4 !== "style") {
      ...
      t2 = r === "dark" ? c.reduce((m2, { type: d, selector: u }) => (s2(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l2, d, t2)), m2), "") : C3(l2 != null ? l2 : ":root,:host", t2);
    }
    if (o) {
      let c = { name: "primeui", order: "primeui" };
      i(o) && (c.name = m(o.name, { name: e, type: s4 })), s2(c.name) && (t2 = C3(`@layer ${c.name}`, t2), a2 == null || a2.layerNames(c.name));
    }
    return t2;
  }
  return "";
...
//# sourceMappingURL=chunk-J6ZWW5XP.js.map
